...
parser.add_argument('--iters', '-iters', help='learning rate of algorithm', default=200000, type=int)
parser.add_argument('--lr', '-lr', help='learning rate of algorithm', default=0.05, type=float)
