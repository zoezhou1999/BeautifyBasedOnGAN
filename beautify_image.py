...
parser.add_argument('--load_vgg_beauty_rater_model', default='../BeautifyBasedOnGAN/beauty_prediction/trained_model/VGG16_beauty_rates-new.pt', help='Model to load for VGG16')
...
constant_labels=beautyrater_model.predict(ref_images)
