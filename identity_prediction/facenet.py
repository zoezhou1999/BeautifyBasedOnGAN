...
class FaceNet():
    ...
    def predict(self, input_batch):
        ...
        embeddings = tf.math.l2_normalize(tf.import_graph_def(graph_def, input_map={'image_batch': input_batch, 'phase_train': False}, return_elements=['embeddings:0'], name='net'))
        # Get output tensor
